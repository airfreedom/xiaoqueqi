...
public class temp_DiscussControl {
    ...
    public int countDiscussNumber(String id){
        int count=0;
        String sql_Select="select * from discuss where proposalid='"+id+"'";
        try {
    ...
    public void showDiscuss(String id,Object[][] data){
        String sql_Select="select * from discuss where proposalid='"+id+"'";
        int i=0;
        try {
            ResultSet rt=st1.executeQuery(sql_Select);
