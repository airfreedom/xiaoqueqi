...
public class yanjiuhui extends JPanel{
    public static void main(String[] args) {
        JFrame frame = new JFrame("yanjiuhui");
        frame.setContentPane(new yanjiuhui().bottom);
    ...
    yanjiuhui() {
        ...
        立案.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                ...
                for(int i=0;i<proposalName.size();i++) {
                    ...
                    proposalWriteContorl.updateYanjiuhuiProposal(name);
                }
            }
        });
    ...
    private ArrayList<String> getSelectedName(){
        ...
        for(int i = 0 ; i < rCount ; i ++){
            if( String.valueOf(table.getValueAt(i,5)) == "true"){
    ...
    class MyTableModel extends AbstractTableModel {
        ...
        public MyTableModel(){
            ...
            ProposalWriteContorl proposalWriteContorl=new ProposalWriteContorl();
            proposalWriteContorl.getConnection();
            count=proposalWriteContorl.countYanjiuhuiProposal();
            data=new Object[count][6];
            proposalWriteContorl.showYanjiuhuiProposal(data);
            //readDatabase(data);
        }
        ...
        private String[] setColumnNames(){
            String[] s = {"编号","提案名称","提案人","专委会","行业分会","选择"};
            return s;
        }
