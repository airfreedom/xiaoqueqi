...
public class zhuanweihui extends JPanel{
//    public static void main(String[] args) {
//        JFrame frame = new JFrame("zhuanweihui");
//        frame.setContentPane(new zhuanweihui().panel1);
...
//    }
    ...
    zhuanweihui() {
        ...
        推荐.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                ...
                for(int i=0;i<proposalName.size();i++) {
                    ...
                    proposalWriteContorl.updateZhuanweihuiProposal(name);
                }
            }
        });
    ...
    private ArrayList<String> getSelectedName(){
        ...
        for(int i = 0 ; i < rCount ; i ++){
            if( String.valueOf(table.getValueAt(i,3)) == "true"){
    ...
    class MyTableModel extends AbstractTableModel {
        ...
        public MyTableModel(){
            ...
            ProposalWriteContorl proposalWriteContorl=new ProposalWriteContorl();
            proposalWriteContorl.getConnection();
            count=proposalWriteContorl.countZhuanweihuiProposal();
            data=new Object[count][4];
            proposalWriteContorl.showRecommendProposal(data);
            //readDatabase(data);
        }
